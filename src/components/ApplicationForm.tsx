  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isAppwriteDbConfigured()) {
      ...
      try {
        ...
        // Profil étudiant retiré de cmsUsers à la demande de l'administrateur. Les candidats restent dans la table `applications` exclusivement.
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-text-secondary">
                  {isLocked 
                    ? "Le programme sélectionné est verrouillé pour cette demande d'admission." 
