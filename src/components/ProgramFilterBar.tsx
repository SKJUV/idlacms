...
import { SearchIcon, RotateCcwIcon, BookOpenIcon, GraduationCapIcon, LayersIcon, ClockIcon } from './Icons';
import { SlidersHorizontal, Check, ArrowUp } from 'lucide-react';
...
export default function ProgramFilterBar({
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // SIDEBAR LAYOUT (Position Fixe & Sticky au Scroll, Style Hugging Face)
  // ════════════════════════════════════════════════════════════════════════════
  if (layout === 'sidebar') {
    return (
      <div className={`bg-bg-secondary border border-border-primary rounded-2xl p-5 shadow-sm space-y-6 lg:sticky lg:top-24 lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto pr-1 transition-all ${className}`}>
        {/* Header & Reset */}
